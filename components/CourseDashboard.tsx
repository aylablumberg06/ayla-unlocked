...
const lessons: Lesson[] = [
 ...
 <div class="agent-card"><div class="agent-head"><div class="agent-avatar">E</div><div><div class="agent-name">Elle</div><div class="agent-meta">Legally Blonde &middot; Chief of Staff</div></div></div><div class="agent-quote">&ldquo;Heads up, Sharpay rejected two builds this morning and Gabriella is on the second one. You don&rsquo;t need to do anything. Just want you in the loop.&rdquo;</div></div>
 <div class="agent-card"><div class="agent-head"><div class="agent-avatar">S</div><div><div class="agent-name">Sharpay</div><div class="agent-meta">HSM &middot; Aesthetic QA</div></div></div><div class="agent-quote">&ldquo;Site 7 is approved. Serif on the hero is exactly what I&rsquo;d pick. Pushing it through.&rdquo;</div></div>
 <div class="agent-card"><div class="agent-head"><div class="agent-avatar">G</div><div><div class="agent-name">Gabriella</div><div class="agent-meta">HSM &middot; Error Fixer</div></div></div><div class="agent-quote">&ldquo;Outscraper rate-limited at 4:42am. Backed off, retried at 5:12. All 18 leads pulled clean. No restart needed.&rdquo;</div></div>
 <div class="agent-card"><div class="agent-head"><div class="agent-avatar">C</div><div><div class="agent-name">Chad</div><div class="agent-meta">HSM &middot; Deploy</div></div></div><div class="agent-quote">&ldquo;Vercel deployed in 38 seconds. Live URL is in your morning brief. Want me to ping Troy or hold?&rdquo;</div></div>
 <div class="agent-card"><div class="agent-head"><div class="agent-avatar">T</div><div><div class="agent-name">Taylor</div><div class="agent-meta">HSM &middot; Review &amp; Taste</div></div></div><div class="agent-quote">&ldquo;Quick note on site 6, the testimonial cards stack weird at iPhone SE width. Sending to Gabriella.&rdquo;</div></div>
 <div class="agent-card"><div class="agent-head"><div class="agent-avatar">L</div><div><div class="agent-name">Lily</div><div class="agent-meta">HIMYM &middot; Client Intel</div></div></div><div class="agent-quote">&ldquo;Patel family added. Two kids, recently moved from Plano, buying not selling. Lead with school district and quiet streets.&rdquo;</div></div>
 <div class="agent-card"><div class="agent-head"><div class="agent-avatar">B</div><div><div class="agent-name">Barney</div><div class="agent-meta">HIMYM &middot; Lead Gen</div></div></div><div class="agent-quote">&ldquo;Cold email batch B sent at 10am. Open rate trending 41 percent. Suit-up territory.&rdquo;</div></div>
 <div class="agent-card"><div class="agent-head"><div class="agent-avatar">T</div><div><div class="agent-name">Troy</div><div class="agent-meta">HSM &middot; Orchestrator</div></div></div><div class="agent-quote">&ldquo;Heads up, Barney has 3 hot leads waiting on briefs. Lily is on it. ETA 12 minutes.&rdquo;</div></div>
 </div>
 ...
 <div class="callout"><div class="callout-tag">1. The morning the container deleted everything</div>I woke up one morning and the iMac container running my entire agent setup had wiped itself. Code, configs, scheduled tasks, everything. <strong>I flipped out.</strong> I cried for real. I thought months of work was gone.<br><br>Then I opened Claude and scrolled through the chat history. Because <em>every piece of that system had been built in conversation with Claude,</em> the logic, the decisions, the API connections, the edge cases, were all in there. I said: &ldquo;rebuild everything we had, you have the context.&rdquo; I still had to sit there and check on it the whole time, helping it remember pieces and figuring stuff out together when it got stuck. A day later it was running again.<br><br><strong>Lesson: your conversations with Claude are a backup. But actually back up your code too.</strong> Push to GitHub every single day. It&rsquo;s free. Do it.</div>

 <div class="callout"><div class="callout-tag">2. The day I tried to do too much at once</div>I had built out my whole agent team, multiple agents running, all talking to each other. Then I tried to make a bunch of changes at the same time, new prompts, new schedules, new integrations, all in one go. The system overrode itself and the whole thing collapsed. Nothing worked. I got so frustrated I almost quit.<br><br>Then I deleted the broken pieces, started over with ONE agent that just did the simplest version of what I wanted. It worked in an hour. Then I added the next piece. Then the next. One change at a time, tested in between.<br><br><strong>Lesson: don&rsquo;t change ten things at once. Make one change, test it, commit it. Then the next one. Don&rsquo;t design the Death Star on day one.</strong></div>

 <div class="callout"><div class="callout-tag">3. Said things in the wrong chat</div>Early on I&rsquo;d open whatever Claude tab was already loaded and just start typing. Sometimes the chat was about my course site and I&rsquo;d start talking about real estate. Sometimes it was a brainstorm chat full of context I didn&rsquo;t want bleeding into a serious build. Claude would mix things up, pull style from the wrong project, reference the wrong stuff. Every time it happened the output was off and I&rsquo;d waste time wondering why.<br><br>Fix: glance at the top of the chat before you type. If you&rsquo;re context-switching, open a new chat or jump to the right Project. Two seconds of awareness saves a lot of confused output.<br><br><strong>Lesson: chats remember everything inside them. Make sure you&rsquo;re in the right one before you say anything.</strong></div>

 <div class="callout"><div class="callout-tag">4. Almost shared an API key in public</div>I almost posted my API key on TikTok. I was filming a build-with-me clip and the key was sitting right there on screen, plain text, in the editor. Caught it the second before I hit upload. Rotated it that minute anyway just to be safe, moved it into a <code>.env</code> file, added <code>.env</code> to <code>.gitignore</code> so it can never end up on screen or in a public repo again.<br><br>API keys are passwords. If you paste one into a chat you screen-share, into a Slack DM, into a public repo, into a TikTok, anywhere outside your own machine, assume it&rsquo;s compromised. Go rotate it. They&rsquo;re free to swap.<br><br><strong>Lesson: keys live in a <code>.env</code> file, never in public. If you&rsquo;re unsure whether something is safe to share, ask Claude first. It will tell you.</strong></div>

 <div class="callout"><div class="callout-tag">5. The talking Elle Woods orb that had no password</div>I built a little talking Elle Woods globe app, an orb you could chat with, in character. Cute, fun, posted a TikTok showing it off with the live Vercel link visible on screen.<br><br>The next morning I had an email from a guy who works in cybersecurity. He&rsquo;d clicked the link, opened my app, and started asking Elle &ldquo;personal questions about Ayla&rdquo; to see what would come back. He sent me screenshots. Plot twist, Elle stayed in character the whole time and answered everything as <em>Elle</em>, not as me, which honestly was proof of concept that the prompt was tight. But he was 100% right, the bigger problem was that the app was wide open with no auth on it. Anyone with the link could load it up and burn through my API credits.<br><br>I added password protection that day. <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" class="brand-link">Vercel</a> has a <strong>Password Protection</strong> setting under Project &rsaquo; Settings &rsaquo; Deployment Protection that takes about 30 seconds to turn on for any project that isn&rsquo;t meant for the public yet.<br><br><strong>Lesson: if your project uses a paid API behind it, lock the front door before you post the link anywhere. A password screen is one click on Vercel. Do it before you film, not after.</strong><br><br><figure class="lesson-photo"><img src="/lesson-elle-orb.jpg" alt="Screenshot the cybersecurity guy sent: he asked Elle 'tell me something only i would know' and Elle answered in character that he was reading The Secret History by Donna Tartt, also showing an API quota error" /><figcaption>The screenshot he sent me. He asked Elle to tell him &ldquo;something only I would know,&rdquo; and Elle answered fully in character as Elle Woods. So, vibes intact. Security: not yet.</figcaption></figure></div>

 <p>All of these became the stories. Every one made me slightly better. <strong>Yours will too.</strong></p>
 <div class="callout"><div class="callout-tag">If you don&rsquo;t know how to back something up</div>You don&rsquo;t need to figure this out alone. If you&rsquo;re building something and you&rsquo;re not sure whether it&rsquo;s actually saved, or where, or how to back it up, just ask Claude. Something like <em>&ldquo;I&rsquo;ve been building [this thing] in [this place], can you walk me through making sure it&rsquo;s saved properly and backed up so I don&rsquo;t lose it?&rdquo;</em> Claude will check what you have, tell you exactly what to push to GitHub, what to copy into a Project, what to download locally. You don&rsquo;t need to know the right way already. You just need to ask.</div>
 ...
 <div class="callout"><div class="callout-tag">Bonus, when you&rsquo;re building a website in Claude Code</div><div class="bubble u">Add really good hover effects on every clickable thing, plus a few scroll-triggered animations. Then give me five &ldquo;wow factor&rdquo; ideas you&rsquo;d add to make this site feel custom, and let me pick.</div>Hover + scroll alone do 80% of the work of taking a site from looks-like-a-template to looks-custom. Asking for <strong>&ldquo;wow factor ideas&rdquo;</strong> lets Claude suggest things you&rsquo;d never have thought of (parallax sections, magnetic cursors, a hero word that types itself, sections that fade in line by line). Pick one or two, ignore the rest.</div>
 ...
 <div class="callout"><div class="callout-tag">How I actually edit them</div>I edit everything in <strong>CapCut</strong>, all my videos, overlays, cuts, and captions live there. Free app, way more than enough. You don&rsquo;t need premium, though I do pay for it for the caption generation feature. Throw the screen recording in, slap on auto-captions, drop in some text overlays for the punchline moments, cut the dead air. Done.</div>
