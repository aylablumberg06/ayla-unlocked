...
const lessons: Lesson[] = [
 ...
 <div class="callout"><div class="callout-tag">1. The day I tried to do too much at once</div>I had built out my whole agent team, multiple agents running, all talking to each other. Then I tried to make a bunch of changes at the same time, new prompts, new schedules, new integrations, all in one go. The system overrode itself and the whole thing collapsed. Code, configs, scheduled tasks, gone. <strong>I flipped out.</strong> I cried for real. I thought months of work was gone.<br><br>Then I opened Claude and scrolled through the chat history. Because <em>every piece of that system had been built in conversation with Claude,</em> the logic, the decisions, the API connections, the edge cases, were all in there. I said: &ldquo;rebuild everything we had, you have the context.&rdquo; I still had to sit there and check on it the whole time, helping it remember pieces and figuring stuff out together when it got stuck. Three hours later it was running again.<br><br><strong>Lesson: don&rsquo;t change ten things at once.</strong> Make one change, test it, commit it. Then the next one. And use Git, push to GitHub every single day. It&rsquo;s free. Do it.</div>
 ...
 <div class="callout"><div class="callout-tag">3. Said things in the wrong chat</div>Early on I&rsquo;d open whatever Claude tab was already loaded and just start typing. Sometimes the chat was about my course site and I&rsquo;d start asking about a real estate client. Sometimes it was a brainstorm chat full of context I didn&rsquo;t want bleeding into a serious build. Claude would mix things up, pull style from the wrong project, reference the wrong client. Every time it happened the output was off and I&rsquo;d waste 20 minutes wondering why.<br><br>Fix: glance at the top of the chat before you type. If you&rsquo;re context-switching, open a new chat or jump to the right Project. Two seconds of awareness saves a half-hour of confused output.<br><br><strong>Lesson: chats remember everything inside them. Make sure you&rsquo;re in the right one before you say anything.</strong></div>

 <div class="callout"><div class="callout-tag">4. Almost shared an API key in public</div>I almost pushed an API key to a public GitHub repo. I was rushing, I had written the key inline in a config file, hit commit, hit push. Caught it because something else broke and I went looking. Rotated the key immediately, moved it to a <code>.env</code> file, added <code>.env</code> to <code>.gitignore</code>.<br><br>API keys are passwords. If you paste one into a chat you screen-share, into a Slack DM, into a public repo, into a TikTok, anywhere outside your own machine, assume it&rsquo;s compromised. Go rotate it. They&rsquo;re free to swap.<br><br><strong>Lesson: keys live in a <code>.env</code> file, never inline, never in public. If you&rsquo;re unsure whether something is safe to share, ask Claude first. It will tell you.</strong></div>
